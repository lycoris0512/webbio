!function (n) {
    ...
    let o = 0;
    const syncLockScreenVideos = () => {
        $(".td-lock-screen .item_video").each(function () {
            const video = this;
    ...
    $("body").append(`<div id="fui-toast"></div><div class="td-lock-screen"><section class="td-welcome"><div class="medias"><video class="pc item_video" autoplay loop muted playsinline><source src="./assets/video/pc.mp4?v=${c()}" type="video/mp4"></video><video class="mobile item_video" autoplay loop muted playsinline><source src="./assets/video/mb.mp4?v=${c()}" type="video/mp4"></video><div class="date"></div></div><div class="infos"><div class="logo-web-title"><img class="logo-ws" src="./assets/img/avatar.gif" alt="Vũ Anh Quân"><span class="web-title">${$("html").attr("data-title-loader") || "M\xe0n H\xecnh Kho\xe1"}</span></div><span class="web_desc"></span><div><i class="ri-arrow-down-line close-lockscreen"></i></div></div></section></div>`);
    syncLockScreenVideos();
    window.addEventListener("resize", syncLockScreenVideos);
    ...
    jQuery(document).ready(function (n) {
        n("body").on("click", function (t) {
            ...
            var e = ["♥️ Năm mới vui vẻ", "❤️ Cung hỉ ph\xe1t t\xe0i", "\uD83D\uDC9B Tiền v\xf4 như nước", "\uD83D\uDC9A Vợ đẹp con ngoan", "\uD83D\uDC99 T\xe0i lộc v\xe0o nh\xe0", "\uD83D\uDC9C Ph\xfac thọ v\xf4 bi\xean", "\uD83D\uDDA4 Sống khoẻ đ\xf3n xu\xe2n", "\uD83D\uDC96 Ph\xfa qu\xfd c\xe1t tường", "\uD83D\uDC9D Đắc lộc to\xe0n gia", "\uD83D\uDC99 Hạnh ph\xfac m\xeanh mang", "❤️ Vạn sự th\xe0nh c\xf4ng", "\uD83D\uDC9A M\xe3 đ\xe1o th\xe0nh c\xf4ng", "\uD83D\uDC99 Tiền v\xf4 tỷ tỷ", "\uD83D\uDC9C T\xe0i vạn c\xf4ng danh", "\uD83D\uDC9B Hạnh ph\xfac gia an", "\uD83D\uDC96 Sức khoẻ như voi", "\uD83D\uDC9B Th\xf4ng minh vượt trội", "\uD83D\uDC96 Ph\xfac lộc trong tay", "\uD83D\uDC9A Gia chủ ph\xe1t t\xe0i", "\uD83D\uDC9A Vạn sự như \xfd", "\uD83D\uDC9A T\xfai tiền nặng k\xfd ", "\uD83D\uDDA4 L\xe0m ăn ph\xe1t đạt", "\uD83D\uDC9B V\xe0ng bạc cao sang", "\uD83D\uDC99 Sức khỏe an nh\xe0n", "\uD83D\uDC9C C\xf4ng danh hết \xfd", "\uD83D\uDDA4 Cung hỷ cung hỷ", "\uD83D\uDC9D Hạnh ph\xfac triền mi\xean", "\uD83D\uDDA4 Sung sướng như ti\xean"]
                , a = n(".click-wish")
                , i = n("<span class='click-wish'>").text(e[d])
                , h = u[Math.floor(Math.random() * u.length)]
                , s = a.length;
            s > 26 && a.slice(0, s - 26).remove();
            d = (d + 1) % e.length;
            var c = t.pageX
                , o = t.pageY
                , r = 42 * Math.random() - 21 + 8 * (s % 5 - 2)
                , l = 16 * Math.random() - 8
                , g = 128 + 58 * Math.random();
            i.css({
                "z-index": Math.floor(9990001 * Math.random()) + 9999,
                "--click-x": c + r + "px",
                "--click-y": o - 18 + l + "px",
                "--click-rise": "-" + g + "px",
                "--click-tilt": 14 * Math.random() - 7 + "deg",
                color: h
            }),
                n("body").append(i),
    ...
    function y() {
        $.ajax({
            url: "//api.thanhdieu.com/cham-ngon",
            type: "get",
            dataType: "json",
            success: function (n) {
